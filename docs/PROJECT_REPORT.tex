...
\begin{figure*}[t]
\centering
\includegraphics[width=0.48\textwidth]{figures/clinical_features_exceedance_heatmap.png}
\includegraphics[width=0.48\textwidth]{figures/bland_altman_qrs_duration.png}
\caption{Additional clinical evaluation visualizations. Left: Percent exceedance heatmap of the error thresholds (QRS/PR/QT/HR) across 12 leads. Right: Bland-Altman comparison for QRS duration (predicted - true) showing mean bias and 95\% limits of agreement.}
\label{fig:clinical_features_additional}
\end{figure*}
